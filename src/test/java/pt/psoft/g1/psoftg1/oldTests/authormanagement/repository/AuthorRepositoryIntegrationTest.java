package pt.psoft.g1.psoftg1.oldTests.authormanagement.repository;
...
public class AuthorRepositoryIntegrationTest {
    ...
    public void whenFindByName_thenReturnAuthor() {
        ...
        alex.assignId(java.util.UUID.randomUUID().toString());
        entityManager.persistAndFlush(alex);

        // when
        List<Author> list = authorRepository.findByName_NameIgnoreCase(alex.getName());
