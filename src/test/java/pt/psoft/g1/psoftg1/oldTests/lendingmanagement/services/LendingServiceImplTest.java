package pt.psoft.g1.psoftg1.oldTests.lendingmanagement.services;
...
class LendingServiceImplTest {
    ...
    void setUp() {
        ...
        readerDetails = new ReaderDetails(1,
                ...
                true,
                null,null);
        readerDetails.assignId(idGenerator.newId("REDDET_"));
 ...
 */
    ...
    void testCreate() {
        ...
        var overdue = Lending.newBootstrappingLending(book, readerDetails, 2024, 997,
            LocalDate.of(2024, 3, 1), null, 15, 300);
        overdue.assignId(idGenerator.newId("LND_"));
    ...
    void testSetReturned() {
        ...
        var notReturnedLending = Lending.newBootstrappingLending(book, readerDetails, year, seq,
            LocalDate.of(2024, 3, 1), null, 15, 300);
