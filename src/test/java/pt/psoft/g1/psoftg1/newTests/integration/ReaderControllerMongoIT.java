...
class ReaderControllerMongoIT extends MongoBackedITBase {
  ...
  void setUp() {
    ...
    mongo.dropCollection("t_user");
    mongo.dropCollection("users");
    mongo.dropCollection("readers");
    mongo.dropCollection("photos");
    mongo.dropCollection("fines");
  ...
  void updateReader_400_withoutIfMatch() throws Exception {
    ...
    mvc.perform(patch("/api/readers")
        ...
        .andExpect(jsonPath("$.detail", containsString("You must issue a conditional PATCH")));
  }
