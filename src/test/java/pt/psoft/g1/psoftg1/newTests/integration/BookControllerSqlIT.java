...
/**
 * Opaque-box integration tests for BookController against a real SQL backend.
...
@Transactional
class BookControllerSqlIT extends SqlBackedITBase {
  ...
  void findByIsbn_200_returnsView_andETag() throws Exception {
    ...
    mvc.perform(get("/api/books/{isbn}", saved.getIsbn()))
        ...
        .andExpect(header().string("ETag", "\"" + saved.getVersion() + "\""))
